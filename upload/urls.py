...
from .views import handleClassPlanFile, handleUploadImage,handle_upload_audio,handleUploadAccident,deleteUploadAccident
...
urlpatterns = [
    ...
    url(r'^call-over-audio/(?P<id>\d{1,6})/$', view=handle_upload_audio, name='upload-audio'),
